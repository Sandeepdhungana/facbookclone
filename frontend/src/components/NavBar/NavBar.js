  ...
  return (
    <section id="navbar">
      ...
      <div className="navbar__icons">
        <li className="navbar__icons--home">
          <NavLink to="/home" activeClassName="activenow">
        ...
        <li className="navbar__icons--watch">
          <NavLink to="/watch" activeClassName="activenow">
        ...
        <li className="navbar__icons--marketplace">
          <NavLink to="/marketplace" activeClassName="activenow">
        ...
        <li className="navbar__icons--group">
          <NavLink to="/group" activeClassName="activenow">
            {/* <img src={groupIcon} alt="marketplace" /> */}
            <svg viewBox="0 0 28 28" height="28" width="28">
        ...
        <li className="navbar__icons--game">
          <NavLink to="/game" activeClassName="activenow">
      ...
      <div className="navbar__namesicons">
        ...
        <div className="navbar__navicons--icons">
          <li className="navbar__navicons--icons--list">
            <i
          ...
          <li className="navbar__navicons--icons--list">
            ...
            <NavLink to="/more" activeClassName='iconactive'>
              <i
                data-visualcompletion="css-img"
                style={{
                  backgroundImage:
